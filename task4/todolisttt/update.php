    ...
    <div class="container">
        <div class="row">
            <div class="col-8 mx-auto">
                <form action="handelers/update_task.php?id=<?= $_GET['id']; ?>" method="POST" class="form border p-2 my-5">
                    ...
                    <input type="submit" value="Save" class="form-control btn btn-primary my-3 " placeholder="New task">
                </form>
            </div>
